            ...
            {walletBalances.map((wallet) => (
              <div key={wallet.address}>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-blue-700 dark:text-blue-300">{wallet.name}</span>
                  {loading && (
                ...
                <div className="text-xs text-blue-600 dark:text-blue-400 font-mono break-all mt-1">
                  {wallet.address}
                </div>
              </div>
            ))}
